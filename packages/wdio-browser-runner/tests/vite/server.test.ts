...
vi.mock('vite-plugin-istanbul', () => ({ default: vi.fn().mockReturnValue('istanbul plugin') }))
...
describe('ViteServer', () => {
    ...
    it('start with coverage enabled', async () => {
        ...
        expect(istanbulPlugin.default).toBeCalledWith({
            cwd: '/foo/bar',
            enabled: true,
            exclude: ['foo', '**/node_modules/**', '**/@wdio/browser-runner/**', '**/packages/wdio-utils/**', '**/packages/wdio-logger/**', '**/packages/wdio-globals/**', '**/packages/*/build/**'],
